...
enum class window_style : DWORD
{
	...
	editcontrol_left = ES_LEFT,
	editcontrol_center = ES_CENTER,
	editcontrol_right = ES_RIGHT,
	editcontrol_multiline = ES_MULTILINE,
	editcontrol_uppercase = ES_UPPERCASE,
	editcontrol_lowercase = ES_LOWERCASE,
	editcontrol_password = ES_PASSWORD,
	editcontrol_auto_vertical_scroll = ES_AUTOVSCROLL,
	editcontrol_auto_horizontal_scroll = ES_AUTOHSCROLL,
	editcontrol_no_hide_selection = ES_NOHIDESEL,
	editcontrol_oem_convert = ES_OEMCONVERT,
	editcontrol_readonly = ES_READONLY,
	editcontrol_want_return = ES_WANTRETURN,
#if(WINVER >= 0x0400)
	editcontrol_number = ES_NUMBER,
#endif
